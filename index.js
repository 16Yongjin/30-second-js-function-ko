...
const template = url => `<!DOCTYPE html><html><head><title>Today's JS Function</title><style>*, body, html{box-sizing: border-box;width: 100%; height: 100%; margin: 0; padding: 0; overflow: hidden;}</style></head><body><iframe src="${url}"> <p>Your browser does not support iframes.</p></iframe></body></html>`
const app = express()
